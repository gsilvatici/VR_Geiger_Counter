...
/*ASDFASFASFAS*/
        ...
        protected override void MoveGrabbedObject(Vector3 pos, Quaternion rot, bool forceTeleport = false)
        {
            ...
            if (m_grabbedObj.snapOffset)
            {
                ...
                if (m_controller == OVRInput.Controller.LTouch) 
                {
                    if (m_grabbedObj.gameObject.CompareTag("Digital Geiger")) {
                        snapOffset.z = snapOffset.x*2;
                        snapOffset.x = 0;
                        snapOffset.y = 0;                    
                    } 
                    if (m_grabbedObj.gameObject.CompareTag("Box")) {
                        //snapOffset.z = 0;
                        //snapOffset.x = 0.2f;
                        //snapOffset.y = 0.2f;                    
                    } 
            ...
            if (m_grabbedObj.snapOffset)
            {
               ...
               if (m_controller == OVRInput.Controller.LTouch && m_grabbedObj.gameObject.CompareTag("Digital Geiger"))
                {
                    m_grabbedObjectRotOff.z = Quaternion.Inverse(m_grabbedObjectRotOff).z; 
                    m_grabbedObjectRotOff.y = Quaternion.Inverse(m_grabbedObjectRotOff).y;;
